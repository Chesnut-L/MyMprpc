...
// bool succes = 3;
inline void LoginResponse::clear_succes() {
  succes_ = false;
}
inline bool LoginResponse::_internal_succes() const {
  return succes_;
}
inline bool LoginResponse::succes() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.succes)
  return _internal_succes();
}
inline void LoginResponse::_internal_set_succes(bool value) {
  
  succes_ = value;
}
inline void LoginResponse::set_succes(bool value) {
  _internal_set_succes(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.succes)
}
